...
AWS Amplify supports many category scenarios such as Auth, Analytics, APIs and Storage as outlined in the [Developer Guide](docs/media/developer_guide.md). A couple of samples are below. For in-depth samples with specific frameworks:
 ...
 - [Vue](https://github.com/aws-samples/aws-amplify-vue)
 - Angular (coming soon)

The examples assume you have an `aws-exports.js` file which describes your backend. This file is autogenerated and created by the [awsmobile-cli](https://github.com/aws/awsmobile-cli):
