...
const resultSyntax = {
    "SyntaxTokens": [
        {
            "BeginOffset": 0, "EndOffset": 4, "PartOfSpeech": { "Score": 0.9982878565788269, "Tag": "INTJ" },
            "Text": "Well", "TokenId": 1
        },
        {
            "BeginOffset": 5, "EndOffset": 9, "PartOfSpeech": { "Score": 0.9992488026618958, "Tag": "PRON" },
            "Text": "this", "TokenId": 2
        },
        {
            "BeginOffset": 10, "EndOffset": 12, "PartOfSpeech": { "Score": 0.9981074333190918, "Tag": "VERB" },
            "Text": "is", "TokenId": 3
        },
        {
            "BeginOffset": 13, "EndOffset": 16, "PartOfSpeech": { "Score": 0.9999936819076538, "Tag": "DET" },
            "Text": "the", "TokenId": 4
        },
        {
            "BeginOffset": 17, "EndOffset": 20, "PartOfSpeech": { "Score": 0.9993390440940857, "Tag": "NOUN" },
            "Text": "end", "TokenId": 5
        },
        {
            "BeginOffset": 20, "EndOffset": 21, "PartOfSpeech": { "Score": 0.9999994039535522, "Tag": "PUNCT" },
            "Text": ",", "TokenId": 6
        },
        {
            "BeginOffset": 22, "EndOffset": 29, "PartOfSpeech": { "Score": 0.9975669384002686, "Tag": "PROPN" },
            "Text": "William", "TokenId": 7
        },
        {
            "BeginOffset": 30, "EndOffset": 34, "PartOfSpeech": { "Score": 0.9923363327980042, "Tag": "PRON" },
            "Text": "what", "TokenId": 8
        },
        {
            "BeginOffset": 35, "EndOffset": 37, "PartOfSpeech": { "Score": 0.9964040517807007, "Tag": "AUX" },
            "Text": "do", "TokenId": 9
        },
        {
            "BeginOffset": 38, "EndOffset": 41, "PartOfSpeech": { "Score": 0.999998927116394, "Tag": "PRON" },
            "Text": "you", "TokenId": 10
        },
        {
            "BeginOffset": 42, "EndOffset": 47, "PartOfSpeech": { "Score": 0.9999972581863403, "Tag": "VERB" },
            "Text": "think", "TokenId": 11
        },
        {
            "BeginOffset": 48, "EndOffset": 53, "PartOfSpeech": { "Score": 0.9784705638885498, "Tag": "ADP" },
            "Text": "about", "TokenId": 12
        },
        {
            "BeginOffset": 54, "EndOffset": 60, "PartOfSpeech": { "Score": 0.9995352029800415, "Tag": "ADJ" },
            "Text": "global", "TokenId": 13
        },
        {
            "BeginOffset": 61, "EndOffset": 68, "PartOfSpeech": { "Score": 0.9905871748924255, "Tag": "NOUN" },
            "Text": "warming", "TokenId": 14
        },
        {
            "BeginOffset": 68, "EndOffset": 69, "PartOfSpeech": { "Score": 0.9999977350234985, "Tag": "PUNCT" },
            "Text": "?", "TokenId": 15
        }]
};
...
const resultKeyPhrases = {
    "KeyPhrases": [
        { "BeginOffset": 13, "EndOffset": 20, "Score": 0.9969043135643005, "Text": "the end" },
        { "BeginOffset": 22, "EndOffset": 29, "Score": 0.9268588423728943, "Text": "William" },
        { "BeginOffset": 54, "EndOffset": 68, "Score": 0.9987823963165283, "Text": "global warming" }
    ]
};
...
describe("Predictions interpret provider test", () => {
    ...
    describe('interpretText tests', () => {
        ...
        test("happy case credentials exist detectEntities", async () => {
            ...
            const detectEntitiesSpy = jest.spyOn(Comprehend.prototype, 'detectEntities');
            expect.assertions(2);

            await expect(predictionsProvider.interpret({
                text: {
                    source: {
                        text: textToTest,
                        language: "en-US"
                ...
                textInterpretation: { "textEntities": [{ "text": "William", "type": "PERSON" }] }
            });
        ...
        test("happy case credentials exists detectDominantLanguage", async () => {
            ...
            const dominantLanguageSpy = jest.spyOn(Comprehend.prototype, 'detectDominantLanguage');
            ...
            expect(dominantLanguageSpy).toBeCalledWith(sdkParams, expect.any(Function));
        });
        ...
        test("happy case credentials exists detect key phrases", async () => {
            ...
            const keyPhrasesSpy = jest.spyOn(Comprehend.prototype, 'detectKeyPhrases');
        ...
        test("happy case credentials type: 'ALL'", async () => {
            ...
            expect(sentimentSpy).toBeCalledWith(sdkParams, expect.any(Function));
            expect(detectEntitiesSpy).toBeCalledWith(sdkParams, expect.any(Function));
            expect(dominantLanguageSpy).toBeCalledWith({ Text: textToTest }, expect.any(Function));
