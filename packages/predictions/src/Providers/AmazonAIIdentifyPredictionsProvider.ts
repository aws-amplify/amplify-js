...
import { DetectTextCommand, DetectTextInput } from "@aws-sdk/client-rekognition-browser/commands/DetectTextCommand";
import { DetectLabelsCommand, DetectLabelsInput } from "@aws-sdk/client-rekognition-browser/commands/DetectLabelsCommand";
import { DetectFacesCommand } from "@aws-sdk/client-rekognition-browser/commands/DetectFacesCommand";
import { DetectModerationLabelsCommand, DetectModerationLabelsInput } from "@aws-sdk/client-rekognition-browser/commands/DetectModerationLabelsCommand";
...
import { DetectDocumentTextCommand, DetectDocumentTextInput } from "@aws-sdk/client-textract-browser/commands/DetectDocumentTextCommand";
import { AnalyzeDocumentCommand, AnalyzeDocumentInput } from "@aws-sdk/client-textract-browser/commands/AnalyzeDocumentCommand";
...
export class AmazonAIIdentifyPredictionsProvider extends AbstractIdentifyPredictionsProvider {
    ...
    private detectModerationLabels(
        ...
        return new Promise((res, rej) => {
            ...
            this.rekognitionClient.send(detectModerationLabelsCommand, (err, data) => {
                if (err) return rej(err);
    ...
    protected identifyEntities(
        ...
        return new Promise(async (res, rej) => {
            ...
            if (
                ...
                this.rekognitionClient.send(recognizeCelebritiesCommand, (err, data) => {
                    if (err) return rej(err);
