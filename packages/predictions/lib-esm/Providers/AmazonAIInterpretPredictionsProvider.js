				...
				return __generator(this, function(_t) {
					switch (_t.label) {
						...
						case 1:
							...
							if (
								!(doAll || interpretType === InterpretTextCategories.ENTITIES)
							)
								return [3 /*break*/, 4];
							_p = language;
						...
						case 4:
							if (
								!(doAll || interpretType === InterpretTextCategories.SENTIMENT)
							)
								return [3 /*break*/, 7];
							_q = language;
						...
						case 10:
							if (
								!(
									doAll || interpretType === InterpretTextCategories.KEY_PHRASES
								)
							)
								return [3 /*break*/, 13];
							_s = language;
