						...
						case 2:
							...
							if (featureTypes.length === 0) {
								...
								this.rekognition.detectText(rekognitionParam, function(
									...
									var rekognitionResponse = IdentifyTextUtils_1.categorizeRekognitionBlocks(
									...
									_this.textract.detectDocumentText(textractParam_1, function(
										...
										if (
											...
											return res(
												IdentifyTextUtils_1.categorizeTextractBlocks(
													textractData.Blocks
												)
											);
										}
				...
				return __generator(this, function(_m) {
					switch (_m.label) {
						...
						case 2:
							...
							param = { Image: inputImage };
							if (
								types_1.isIdentifyCelebrities(input.entities) &&
								...
								this.rekognition.recognizeCelebrities(param, function(
									...
									var faces = data.CelebrityFaces.map(function(celebrity) {
										return {
											boundingBox: Utils_1.makeCamelCase(
												celebrity.Face.BoundingBox
											),
											landmarks: Utils_1.makeCamelCaseArray(
												celebrity.Face.Landmarks
											),
											metadata: __assign(
												__assign(
													{},
													Utils_1.makeCamelCase(celebrity, [
														'Id',
														'Name',
														'Urls',
													])
								...
								types_1.isIdentifyFromCollection(input.entities) &&
								...
								this.rekognition.detectFaces(param, function(err, data) {
									...
									var faces = data.FaceDetails.map(function(detail) {
										...
										var faceAttributes = Utils_1.makeCamelCase(
											detail,
											attributeKeys
										);
										if (detail.Emotions) {
