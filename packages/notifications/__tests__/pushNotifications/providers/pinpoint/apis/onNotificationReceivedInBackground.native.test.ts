...
import { onNotificationReceivedInBackground } from '../../../../../src/pushNotifications/providers/pinpoint/apis/onNotificationReceivedInBackground.native';

jest.mock('../../../../../src/eventListeners');
jest.mock('../../../../../src/pushNotifications/errors/errorHelpers');

describe('onNotificationReceivedInBackground (native)', () => {
	// create mocks
	...
	it('must be initialized', () => {
		...
		expect(() => onNotificationReceivedInBackground(mockHandler)).toThrow();
	});
