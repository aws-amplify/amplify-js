...
interface ButtonProps {
	action?: any; // what else
	//   action?: "close"; // what else
	url?: string; // are deep links just provided as URL?
...
export interface InAppMessageProps {
	...
	style?: InAppMessageStyle['backgroundColor'];
}

export interface InAppMessage {
	props: InAppMessageProps;
	priority: 1 | 2 | 3 | 4 | 5;
	campaignId: string;
	sessionCap: number;
}
