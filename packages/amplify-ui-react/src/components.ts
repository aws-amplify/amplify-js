...
export const AmplifyExamples = /*@__PURE__*/createReactComponent<JSX.AmplifyExamples, HTMLAmplifyExamplesElement>('amplify-examples');
...
export const AmplifyScene = /*@__PURE__*/createReactComponent<JSX.AmplifyScene, HTMLAmplifySceneElement>('amplify-scene');
export const AmplifySceneLoading = /*@__PURE__*/createReactComponent<JSX.AmplifySceneLoading, HTMLAmplifySceneLoadingElement>('amplify-scene-loading');
