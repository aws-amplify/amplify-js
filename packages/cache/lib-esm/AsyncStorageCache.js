			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						...
						return [
							4 /*yield*/,
							AsyncStorage.setItem(prefixedKey, JSON.stringify(item)),
						];
					case 1:
						_a.sent();
	...
	AsyncStorageCache.prototype.getCacheCurSize = function() {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, AsyncStorage.getItem(this.cacheCurSizeKey)];
					case 1:
						ret = _a.sent();
						if (!!ret) return [3 /*break*/, 3];
						return [
							4 /*yield*/,
							AsyncStorage.setItem(this.cacheCurSizeKey, '0'),
						];
					case 2:
						_a.sent();
						ret = '0';
