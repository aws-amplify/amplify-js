			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					...
					case 1:
						...
						return [
							4 /*yield*/,
							react_native_1.AsyncStorage.setItem(
	...
	AsyncStorageCache.prototype._isExpired = function(key) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, react_native_1.AsyncStorage.getItem(key)];
					case 1:
						text = _a.sent();
			...
			return __generator(this, function(_d) {
				switch (_d.label) {
					...
					case 1:
						...
						return [
							4 /*yield*/,
							react_native_1.AsyncStorage.getItem(prefixedKey),
						];
					case 2:
					...
					case 5:
						...
						return [
							4 /*yield*/,
							react_native_1.AsyncStorage.removeItem(prefixedKey),
						];
					case 6:
						_d.sent();
						return [3 /*break*/, 9];
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					case 0:
						...
						return [4 /*yield*/, this.getCacheCurSize()];
					case 1:
						return [2 /*return*/, _a + _b.sent() > this.config.capacityInBytes];
				}
			});
		});
	};
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						...
						if (
							cacheItemOptions.priority < 1 ||
							cacheItemOptions.priority > 5
						) {
							logger.warn(
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						logger.debug(
							'Get item: key is ' + key + ' with options ' + options
						);
						ret = null;
						prefixedKey = this.config.keyPrefix + key;
						if (
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					...
					case 3:
						...
						return [
							4 /*yield*/,
							react_native_1.AsyncStorage.removeItem(keysToRemove[i]),
						];
					case 4:
						_a.sent();
						_a.label = 5;
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [
							4 /*yield*/,
							react_native_1.AsyncStorage.getItem(this.cacheCurSizeKey),
						];
					case 1:
						ret = _a.sent();
						...
						return [
							4 /*yield*/,
							react_native_1.AsyncStorage.setItem(this.cacheCurSizeKey, '0'),
						];
					case 2:
						_a.sent();
						ret = '0';
