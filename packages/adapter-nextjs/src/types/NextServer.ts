...
export declare namespace NextServer {
	...
	/**
	 * The interface of the input to run an operation in a server context.
	 */
	...
	export type CreateServerRunner = (input: CreateServerRunnerInput) => CreateServerRunnerOutput;
}
