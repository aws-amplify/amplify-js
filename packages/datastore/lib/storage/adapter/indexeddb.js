			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [
							4 /*yield*/,
							util_1.isPrivateMode().then(function(isPrivate) {
								return isPrivate;
							}),
						];
					case 1:
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					...
					case 1:
						...
						connectedModels = util_1.traverseModel(
					...
					case 2:
						fromDB = _b.sent();
						if (condition) {
							predicates = predicates_1.ModelPredicateCreator.getPredicates(
								condition
							);
					...
					case 6:
						...
						filtered = predicateObjs_1
							? all.filter(function(m) {
									return util_1.validatePredicate(m, type_1, predicateObjs_1);
							  })
							: all;
						return [
							4 /*yield*/,
					...
					case 1:
						...
						return [
							...
							this.db
								...
								.openCursor(
									undefined,
									firstOrLast === types_1.QueryOne.FIRST ? 'next' : 'prev'
								),
						];
					case 2:
						cursor = _a.sent();
