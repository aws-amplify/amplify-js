...
var MutationProcessor = /** @class */ (function() {
									...
									return __awaiter(_this, void 0, void 0, function() {
										...
										return __generator(this, function(_d) {
											switch (_d.label) {
												...
												case 9:
													namespace = this.schema.namespaces[USER];
													updatedMutation = createMutationInstanceFromModelOperation(
	...
	MutationProcessor.prototype.createQueryVariables = function(
		...
		var modelDefinition = this.schema.namespaces[USER].models[model];
