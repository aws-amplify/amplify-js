					...
					return __generator(this, function(_a) {
						switch (_a.label) {
							...
							case 2:
								...
								return [2 /*return*/];
							case 3:
								new Reachability().networkMonitor().subscribe(function(_a) {
												...
												return __generator(this, function(_b) {
													switch (_b.label) {
														case 0:
															...
															graphQLCondition = predicateToGraphQLCondition(
																condition
															);
															mutationEvent = createMutationInstanceFromModelOperation(
