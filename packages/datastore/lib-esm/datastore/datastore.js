		...
		return __generator(this, function(_a) {
			switch (_a.label) {
				...
				case 1:
					...
					producedCondition = ModelPredicateCreator.createFromExisting(
						modelDefinition,
						condition
					);
					return [
			...
			switch (_a.label) {
				...
				case 1:
					...
					if (typeof idOrCriteria === 'string') {
						condition = ModelPredicateCreator.createForId(
				...
				case 3:
					...
					modelDefinition = getModelDefinition(modelConstructor);
					idPredicate = ModelPredicateCreator.createForId(
						modelDefinition,
						model.id
					);
					if (idOrCriteria) {
		...
		return __generator(this, function(_b) {
			switch (_b.label) {
				...
				case 1:
					...
					predicate_1 = ModelPredicateCreator.createForId(
						getModelDefinition(modelConstructor),
						idOrCriteria
					);
				...
				case 3:
					predicate = !isPredicatesAll(idOrCriteria)
						? ModelPredicateCreator.createFromExisting(
								getModelDefinition(modelConstructor),
								idOrCriteria
						  )
