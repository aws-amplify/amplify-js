...
var AWSPinpointProvider = /** @class */ (function() {
			...
			return __generator(this, function(_a) {
				...
				switch (event.name) {
					case UPDATE_ENDPOINT:
						return [
							2 /*return*/,
							this._updateEndpoint({ params: params, handlers: handlers }),
						];
					case SESSION_STOP:
						return [
							2 /*return*/,
	...
	AWSPinpointProvider.prototype._pinpointPutEvents = function(
		params,
		handlers
	) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_d) {
				switch (_d.label) {
					...
					case 1:
						...
						return [
							4 /*yield*/,
							this.pinpointClient.putEvents(eventParams).promise(),
						];
					case 2:
						data = _d.sent();
						(_a = endpointId),
	...
	AWSPinpointProvider.prototype._pinpointSendStopSession = function(
		params,
		handlers
	) {
		if (!BEACON_SUPPORTED) {
		...
		var requestUrl = core_1.Signer.signUrl(
			request,
			accessInfo,
			serviceInfo,
			null
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					...
					case 1:
						...
						return [
							4 /*yield*/,
							this.pinpointClient.updateEndpoint(update_params).promise(),
						];
					case 2:
						data = _a.sent();
	...
	AWSPinpointProvider.prototype._handleEndpointUpdateFailure = function(
		failureData
	) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				...
				switch (statusCode) {
					case BAD_REQUEST_CODE:
						return [
							2 /*return*/,
							this._handleEndpointUpdateBadRequest(failureData),
						];
					case FORBIDDEN_CODE:
						return [
							2 /*return*/,
	...
	AWSPinpointProvider.prototype._handleEndpointUpdateBadRequest = function(
		failureData
	) {
		return __awaiter(this, void 0, void 0, function() {
			var err,
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						(err = failureData.err),
							(update_params = failureData.update_params),
							(endpointObject = failureData.endpointObject);
						message = err.message;
						(ApplicationId = update_params.ApplicationId),
							(EndpointRequest = update_params.EndpointRequest);
						if (
					...
					case 3:
						err_3 = _a.sent();
						logger.warn(
							'Failed to remove unused endpoints with error: ' + err_3
						);
						logger.warn(
	...
	AWSPinpointProvider.prototype._handleEndpointUpdateForbidden = function(
		failureData
	) {
	...
	AWSPinpointProvider.prototype._retryEndpointUpdate = function(
		endpointObject,
		exponential
	) {
	...
	AWSPinpointProvider.prototype._removeUnusedEndpoints = function(
		appId,
		userId
	) {
		return __awaiter(this, void 0, void 0, function() {
					...
					new Promise(function(res, rej) {
						_this.pinpointClient.getUserEndpoints(
							...
							function(err, data) {
								if (err) {
									logger.debug(
										'Failed to get endpoints associated with the userId: ' +
											userId +
											' with error',
										err
									);
								...
								logger.debug(
									'get endpoints associated with the userId: ' +
										userId +
										' with data',
									endpoints
								);
								...
								for (var i = 1; i < endpoints.length; i++) {
									var timeStamp1 = Date.parse(
										endpointToBeDeleted['EffectiveDate']
									);
								...
								_this.pinpointClient.updateEndpoint(update_params, function(
									err,
									data
								) {
									if (err) {
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				...
				if (
					...
					logger.debug(
						'no change for aws credentials, directly return from init'
					);
					return [2 /*return*/];
				}
	...
	AWSPinpointProvider.prototype._getEndpointId = function(cacheKey) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, cache_1.default.getItem(cacheKey)];
					case 1:
						endpointId = _a.sent();
						logger.debug(
	...
	AWSPinpointProvider.prototype._endpointRequest = function(config, event) {
		...
		var clientId = clientContext.clientId,
			...
			demographicByClientContext = __rest(clientContext, [
				'clientId',
				'appTitle',
				'appVersionName',
				'appVersionCode',
		...
		var tmp = __assign(
			...
			{
				attributes: __assign(
					__assign({}, defaultEndpointConfig.attributes),
					event.attributes
				),
				demographic: __assign(
					__assign(
						__assign(
							__assign({}, demographicByClientInfo),
				...
				location: __assign(
					__assign({}, defaultEndpointConfig.location),
					event.location
				),
				metrics: __assign(
					__assign({}, defaultEndpointConfig.metrics),
					event.metrics
				),
				user: {
					userId:
					...
					userAttributes: __assign(
						__assign({}, defaultEndpointConfig.userAttributes),
		...
		return core_1.JS.transferKeyToUpperCase(
			ret,
			[],
