...
/**
 * Configures automatic event tracking for Personalize. This API will automatically transmit an analytic event when
 ...
 *
 * @throws service: {@link UpdateEndpointException} - Thrown when the underlying Personalize service returns an error.
