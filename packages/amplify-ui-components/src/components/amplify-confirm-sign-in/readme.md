...
| `headerText`            | `header-text`        | Used for header text in confirm sign in component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `string`                                            | `I18n.get(AuthMessages.CONFIRM_SMS_CODE)`                                                                                      |
| `submitButtonText`      | `submit-button-text` | Used for the submit button text in confirm sign in component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `string`                                            | `I18n.get(AuthMessages.CONFIRM)`                                                                                               |
