...
| `hint`              | `hint`        | The text of a hint to the user as to how to fill out the input.  Goes just below the input.                                                        | `FunctionalComponent<{}> or string`                                                             | `undefined` |
...
| `type`              | `type`        | The input type.  Can be any HTML input type.                                                                                                       | `"date" or "email" or "number" or "password" or "search" or "tel" or "text" or "time" or "url"` | `'text'`    |
