...
| `handleAuthStateChange` | --                   | Passed from the Authenticatior component in order to change Authentication states e.g. SignIn -> 'Create Account' link -> SignUp                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `(nextAuthState: AuthState, data?: string \| object) => void` | `undefined`                          |
...
| `user`                  | --                   | Used for the username to be passed to resend code                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `CognitoUserType`                                             | `undefined`                          |
