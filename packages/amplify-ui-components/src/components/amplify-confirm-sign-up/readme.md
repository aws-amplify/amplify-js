...
| `handleAuthStateChange` | --                   | Passed from the Authenticator component in order to change Authentication states e.g. SignIn -> 'Create Account' link -> SignUp                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `(nextAuthState: AuthState, data?: string \| object) => void` | `undefined`                          |
