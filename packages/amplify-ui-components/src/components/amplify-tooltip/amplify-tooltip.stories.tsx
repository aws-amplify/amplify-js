...
storiesOf('amplify-tooltip', module).add('with text', () => {
  ...
  return `<div style="margin-bottom:60px"></div> <amplify-tooltip text="${text}" should-auto-show=${autoShow} override-style=${override}><amplify-button>Tooltip test</amplify-button></amplify-tooltip>`;
});
