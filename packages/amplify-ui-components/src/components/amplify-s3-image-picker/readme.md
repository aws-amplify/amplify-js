...
| ----------------- | ------------------ | ------------------------------------------------------ | -------------------------------------------------------------------- | ------------------------------------------------------ |
| `buttonText`      | `button-text`      | Upload Button Text as string                           | `string`                                                             | `I18n.get(Translations.IMAGE_PICKER_BUTTON_TEXT)`      |
...
| `headerHint`      | `header-hint`      | Header Hint value in string                            | `string`                                                             | `I18n.get(Translations.IMAGE_PICKER_HINT)`             |
| `headerTitle`     | `header-title`     | Title string value                                     | `string`                                                             | `I18n.get(Translations.IMAGE_PICKER_TITLE)`            |
...
| `placeholderHint` | `placeholder-hint` | Placeholder hint that goes under the placeholder image | `string`                                                             | `I18n.get(Translations.IMAGE_PICKER_PLACEHOLDER_HINT)` |
