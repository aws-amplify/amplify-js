...
| `label`             | `label`       | Used for the code label                                                                                            | `string`                            | `I18n.get(AuthMessages.CODE_LABEL)`       |
| `placeholder`       | `placeholder` | Used for the placeholder label                                                                                     | `string`                            | `I18n.get(AuthMessages.CODE_PLACEHOLDER)` |
