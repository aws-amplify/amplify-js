...
| `label`             | `label`       | Used for the username label                                                                                        | `string`                      | `I18n.get(AuthMessages.USERNAME_LABEL)`       |
| `placeholder`       | `placeholder` | Used for the placeholder label                                                                                     | `string`                      | `I18n.get(AuthMessages.USERNAME_PLACEHOLDER)` |
