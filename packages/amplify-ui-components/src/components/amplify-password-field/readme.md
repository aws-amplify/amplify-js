...
| `label`             | `label`       | Used for the password label                                                                                        | `string`                            | `I18n.get(AuthMessages.PASSWORD_LABEL)`       |
| `placeholder`       | `placeholder` | Used for the placeholder label                                                                                     | `string`                            | `I18n.get(AuthMessages.PASSWORD_PLACEHOLDER)` |
