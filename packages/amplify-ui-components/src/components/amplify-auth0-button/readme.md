...
| `handleAuthStateChange` | --               |                                                                       | `(nextAuthState: AuthState, data?: object) => void`                                                                                      | `(nextAuthState: AuthState, data?: object) => {     Hub.dispatch('AuthenticatorState', { event: nextAuthState, data });   }` |
