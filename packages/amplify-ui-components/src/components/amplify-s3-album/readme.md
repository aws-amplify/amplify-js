...
| `path`          | `path`         | String representing directory location to list image files       | `string`                                                             | `undefined`                          |
| `picker`        | `picker`       | Boolean to enable or disable picker                              | `boolean`                                                            | `true`                               |
| `pickerText`    | `picker-text`  | Picker button text                                               | `string`                                                             | `I18n.get(Translations.PICKER_TEXT)` |
