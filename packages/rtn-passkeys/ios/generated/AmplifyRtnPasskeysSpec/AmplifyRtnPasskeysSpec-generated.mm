...
@end
@implementation RCTCxxConvert (NativeAmplifyRtnPasskeys_PubKeyCredParam)
+ (RCTManagedPointer *)JS_NativeAmplifyRtnPasskeys_PubKeyCredParam:(id)json
{
  return facebook::react::managedPointer<JS::NativeAmplifyRtnPasskeys::PubKeyCredParam>(json);
}
@end
...
@end
@implementation RCTCxxConvert (NativeAmplifyRtnPasskeys_PasskeyCreateOptionsJsonAuthenticatorSelection)
+ (RCTManagedPointer *)JS_NativeAmplifyRtnPasskeys_PasskeyCreateOptionsJsonAuthenticatorSelection:(id)json
{
  return facebook::react::managedPointer<JS::NativeAmplifyRtnPasskeys::PasskeyCreateOptionsJsonAuthenticatorSelection>(json);
}
@end
@implementation RCTCxxConvert (NativeAmplifyRtnPasskeys_PasskeyCreateOptionsJsonExtensions)
+ (RCTManagedPointer *)JS_NativeAmplifyRtnPasskeys_PasskeyCreateOptionsJsonExtensions:(id)json
{
  return facebook::react::managedPointer<JS::NativeAmplifyRtnPasskeys::PasskeyCreateOptionsJsonExtensions>(json);
}
@end
