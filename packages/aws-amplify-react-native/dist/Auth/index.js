...
import { FederatedSignIn, FederatedButtons } from './FederatedSignIn';

const logger = new Logger('auth components');

export { Authenticator, AuthPiece, SignIn, ConfirmSignIn, SignUp, ConfirmSignUp, ForgotPassword, Loading, RequireNewPassword, VerifyContact, Greetings, FederatedButtons, FederatedSignIn };
