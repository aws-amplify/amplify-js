Object.defineProperty(exports,"__esModule",{value:true});exports.default=undefined;var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _jsxFileName='src/components/auth/RequireNewPassword.js';
...
RequireNewPassword=function(_AuthPiece){_inherits(RequireNewPassword,_AuthPiece);
function RequireNewPassword(props){_classCallCheck(this,RequireNewPassword);var _this=_possibleConstructorReturn(this,(RequireNewPassword.__proto__||Object.getPrototypeOf(RequireNewPassword)).call(this,
props));
...
}_createClass(RequireNewPassword,[{key:'change',value:function change()

{var _this2=this;
var user=this.props.authData;var
password=this.state.password;
logger.debug('Require new password for '+user.username);
_Auth2.default.completeNewPassword(user,password,user.challengeParam.requiredAttributes).
...
theme:theme,
onChangeText:function onChangeText(text){return _this3.setState({password:text});},__source:{fileName:_jsxFileName,lineNumber:69}}),

_react2.default.createElement(_AmplifyUI.Button,{
theme:theme,
title:_I18n2.default.get('Change Password'),
onPress:this.change,
...
}}]);return RequireNewPassword;}(_AuthPiece3.default);exports.default=RequireNewPassword;