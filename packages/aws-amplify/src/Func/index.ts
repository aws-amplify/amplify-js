...
const logger = new Logger('Func');

let _instance = null;

if (!_instance) {
    logger.debug('Create Func Instance');
    _instance = new FuncClass(null);
    _instance.vault = new FuncClass({ level: 'private' });
