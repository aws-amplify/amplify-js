...
describe('ForgotPasswordComponentCore (classOverides unused): ', () => {

  let comp: ForgotPasswordComponentCore;
  let fixture: ComponentFixture<ForgotPasswordComponentCore>; 
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [ForgotPasswordComponentCore],
...
describe('ForgotPasswordComponentCore (classOverides global only): ', () => {
...
describe('ForgotPasswordComponentCore (classOverides global and component): ', () => {
