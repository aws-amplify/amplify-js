...
describe('RequireNewPasswordComponentIonic (classOverides unused): ', () => {

  let comp: RequireNewPasswordComponentIonic;
  let fixture: ComponentFixture<RequireNewPasswordComponentIonic>; 
  ...
  beforeEach(() => {
    ...
    comp.authState = { state: 'requireNewPassword', user: {} };
...
describe('RequireNewPasswordComponentIonic (classOverides global only): ', () => {
...
describe('RequireNewPasswordComponentIonic (classOverides global and component): ', () => {
  ...
  beforeEach(() => {
    ...
    comp._requireNewPasswordConfig = {
      classOverrides: {
