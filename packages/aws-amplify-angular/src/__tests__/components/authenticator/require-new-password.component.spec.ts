...
import { RequireNewPasswordComponentCore, RequireNewPasswordComponentIonic } from '../../../components/authenticator/require-new-password-component'
...
describe('RequireNewPasswordComponentIonic: ', () => {
