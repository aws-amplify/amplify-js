...
describe('RequireNewPasswordComponentCore (classOverides unused): ', () => {

  let comp: RequireNewPasswordComponentCore;
  let fixture: ComponentFixture<RequireNewPasswordComponentCore>; 
...
describe('RequireNewPasswordComponentCore (classOverides global only): ', () => {
...
describe('RequireNewPasswordComponentCore (classOverides global and component): ', () => {
