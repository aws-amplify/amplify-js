...
describe('SignUpComponentIonic (classOverides unused): ', () => {

  let comp: SignUpComponentIonic;
  let fixture: ComponentFixture<SignUpComponentIonic>; 
...
describe('SignUpComponentIonic (classOverides global only): ', () => {
  ...
  it('...it should have 3 inputs with an AmplifyUI class and a _classOverrides class', () => {
...
describe('SignUpComponentIonic (classOverides global and component): ', () => {
