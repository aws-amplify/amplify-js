...
describe('ConfirmSignUpComponentCore (classOverides unused): ', () => {

  let comp: ConfirmSignUpComponentCore;
  let fixture: ComponentFixture<ConfirmSignUpComponentCore>; 
...
describe('ConfirmSignUpComponentCore (classOverides global only): ', () => {
  ...
  it('...it should have a formSection with an AmplifyUI class and _classOverrides class', () => {
  ...
  it('...it should have two formFields with an AmplifyUI class and a _classOverrides class', () => {
    const formField = signInEl.querySelectorAll(`.${ui.formField}.formFieldClass`);
    expect(formField.length).toEqual(2);
  });

  it('...it should have two inputs with an AmplifyUI class and a _classOverrides class', () => {
...
describe('ConfirmSignUpComponentCore (classOverides global and component): ', () => {
