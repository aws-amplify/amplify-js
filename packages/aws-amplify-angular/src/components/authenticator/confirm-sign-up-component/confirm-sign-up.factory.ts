...
export class ConfirmSignUpComponent implements OnInit, OnDestroy {
  ...
  loadComponent() {
    ...
    new ComponentMount(ConfirmSignUpComponentIonic,{authState: this.authState, usernameAttributes: this.usernameAttributes}) :
    new ComponentMount(ConfirmSignUpComponentCore, {authState: this.authState, usernameAttributes: this.usernameAttributes});
