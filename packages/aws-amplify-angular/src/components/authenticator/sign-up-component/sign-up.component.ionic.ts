...
<div class="amplify-authenticator amplify-authenticator-ionic" *ngIf="_show">
  <div class="amplify-form-body">
    <div class="amplify-form-header amplify-form-header-ionic">Create a new account</div>
    <ion-list>
      <ion-item lines="none">
      ...
      <ion-item lines="none">
        <ion-label class="amplify-input-label amplify-input-label-ionic" position="stacked">Email *</ion-label>
        <ion-input 
          #email
          type="text"
          class="amplify-form-input"
      ...
      <ion-item lines="none">
        <ion-label class="amplify-input-label amplify-input-label-ionic" position="stacked">Phone Number *</ion-label>
        <ion-grid>
          <ion-row>
            <ion-col size="3">
              <ion-select #countryCode
              name="countryCode" 
              class="amplify-select-phone-country amplify-phone-ionic-selection" 
            ...
            <ion-col size="9">
              ...
              #phone_number
              type="text"
              class="amplify-form-input amplify-phone-ionic-input"
