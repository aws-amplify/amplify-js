...
const template = `
  <ion-button
    expand="block" 
    id={{amplifyUI.googleSignInButton}} 
    class={{amplifyUI.signInButton}} 
    variant="googleSignInButton" 
    style="line-height: 16px; --background: #4285F4;"
    (click)="onSignIn()"
  >
    <span class={{amplifyUI.signInButtonIcon}} style="box-sizing: content-box; padding: 10px;">
