...
(function ExportLibrary(root, factory) {
    ...
    var PahoMQTT = (function(global) {
                ...
                case MESSAGE_TYPE.CONNECT:
                    ...
                    if (this.willMessage !== undefined) {
                        ...
                        if (!(willMessagePayloadBytes instanceof Uint8Array))
                            willMessagePayloadBytes = new Uint8Array(
                                payloadBytes
                            );
        ...
        function decodeMessage(input, pos) {
            ...
            switch (type) {
                ...
                case MESSAGE_TYPE.PUBLISH:
                    ...
                    var message = new PahoMQTT.Message(
            ...
            for (var i = 0; i < input.length; i++) {
                ...
                if (0xd800 <= charCode && charCode <= 0xdbff) {
                    ...
                    if (isNaN(lowCharCode)) {
                        throw new Error(
                            format(ERROR.MALFORMED_UNICODE, [
                                charCode,
                                lowCharCode,
                            ])
                        );
        ...
        ClientImpl.prototype.connect = function(connectOptions) {
            var connectOptionsMasked = this._traceMask(
                connectOptions,
                'password'
            );
            this._trace(
            ...
            if (this.connected)
                throw new Error(
                    format(ERROR.INVALID_STATE, ['already connected'])
                );
            if (this.socket)
                throw new Error(
                    format(ERROR.INVALID_STATE, ['already connected'])
            ...
            if (subscribeOptions.timeout) {
                wireMessage.timeOut = new Timeout(
                    ...
                    [
                        {
                            invocationContext:
                                subscribeOptions.invocationContext,
        ...
        /** @ignore */
        ClientImpl.prototype.unsubscribe = function(
            filter,
            unsubscribeOptions
        ) {
        ...
        ClientImpl.prototype.send = function(message) {
            ...
            if (this.connected) {
                ...
                if (this._reconnecting && this.disconnectedPublishing) {
                    ...
                    throw new Error(
                        format(ERROR.INVALID_STATE, ['not connected'])
                    );
                }
            }
        };
        ...
        ClientImpl.prototype.disconnect = function() {
            ...
            this._notify_msg_sent[wireMessage] = scope(
                this._disconnected,
                this
            );
        ...
        ClientImpl.prototype.restore = function(key) {
            ...
            switch (storedMessage.type) {
                ...
                default:
                    throw Error(
                        format(ERROR.INVALID_STORED_DATA, [key, value])
                    );
            }
            ...
            try {
                switch (wireMessage.type) {
                    ...
                    case MESSAGE_TYPE.PUBREL:
                        ...
                        var pubCompMessage = new WireMessage(
                            MESSAGE_TYPE.PUBCOMP,
                            {
                                messageIdentifier:
                                    wireMessage.messageIdentifier,
                            }
        ...
        ClientImpl.prototype._socket_send = function(wireMessage) {
            if (wireMessage.type == 1) {
                var wireMessageMasked = this._traceMask(
                    wireMessage,
                    'password'
                );
        ...
        ClientImpl.prototype._receivePublish = function(wireMessage) {
            switch (wireMessage.payloadMessage.qos) {
                ...
                default:
                    throw Error(
                        'Invaild qos=' + wireMessage.payloadMessage.qos
                    );
            }
        };
        ...
        var Client = function(host, port, path, clientId) {
            ...
            if (typeof host !== 'string')
                throw new Error(
                    format(ERROR.INVALID_TYPE, [typeof host, 'host'])
                );
            ...
            if (arguments.length == 2) {
                ...
                if (match) {
                    ...
                    throw new Error(
                        format(ERROR.INVALID_ARGUMENT, [host, 'host'])
                    );
                }
            } else {
            ...
            this.connect = function(connectOptions) {
                ...
                if (connectOptions.willMessage) {
                    ...
                    if (
                        ...
                        throw new Error(
                            format(ERROR.INVALID_TYPE, [
                                typeof connectOptions.willMessage
                                    .destinationName,
        ...
        var Message = function(newPayload) {
            ...
            if (
                ...
                (ArrayBuffer.isView(newPayload) &&
                    !(newPayload instanceof DataView))
            ) {
                payload = newPayload;
            } else {
