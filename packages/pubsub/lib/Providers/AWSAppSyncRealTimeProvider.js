...
var AWSAppSyncRealTimeProvider = /** @class */ (function(_super) {
	...
	AWSAppSyncRealTimeProvider.prototype.publish = function(
		_topics,
		_msg,
		_options
	) {
						...
						return __generator(this, function(_a) {
							switch (_a.label) {
								...
								case 1:
									// Waiting that subscription has been connected before trying to unsubscribe
									_a.sent();
									subscriptionState = this.subscriptionObserverMap.get(
										subscriptionId_1
									).subscriptionState;
									if (subscriptionState === SUBSCRIPTION_STATUS.CONNECTED) {
										...
										throw new Error(
											'Subscription fail, start removing subscription'
										);
									}
									return [3 /*break*/, 3];
								case 2:
	...
	AWSAppSyncRealTimeProvider.prototype._startSubscriptionWithAWSAppSyncRealTime = function(
		_a
	) {
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_g) {
				switch (_g.label) {
					case 0:
						(appSyncGraphqlEndpoint = options.appSyncGraphqlEndpoint),
							(authenticationType = options.authenticationType),
							(query = options.query),
							(variables = options.variables),
							(apiKey = options.apiKey),
							(region = options.region),
							(_b = options.graphql_headers),
							(graphql_headers =
								_b === void 0
									? function() {
											return {};
					...
					case 1:
						headerObj = __assign.apply(void 0, [
							__assign.apply(void 0, _c.concat([_g.sent()])),
							((_f = {}),
							(_f[core_1.USER_AGENT_HEADER] = core_1.Constants.userAgent),
							_f),
						]);
						subscriptionMessage = {
							id: subscriptionId,
					...
					case 4:
						...
						observer.error({
							errors: [
								__assign(
									{},
									new graphql_1.GraphQLError('Connection failed: ' + message)
								),
							],
						});
						observer.complete();
						...
						return [2 /*return*/];
					case 5:
						(_e = this.subscriptionObserverMap.get(subscriptionId)),
							(subscriptionFailedCallback = _e.subscriptionFailedCallback),
							(subscriptionReadyCallback = _e.subscriptionReadyCallback);
	...
	// Waiting that subscription has been connected before trying to unsubscribe
	AWSAppSyncRealTimeProvider.prototype._waitForSubscriptionToBeConnected = function(
		subscriptionId
	) {
		return __awaiter(this, void 0, void 0, function() {
			...
			var _this = this;
			return __generator(this, function(_a) {
				subscriptionState = this.subscriptionObserverMap.get(subscriptionId)
					.subscriptionState;
	...
	AWSAppSyncRealTimeProvider.prototype._sendUnsubscriptionMessage = function(
		subscriptionId
	) {
		try {
			if (
	...
	AWSAppSyncRealTimeProvider.prototype._removeSubscriptionObserver = function(
		subscriptionId
	) {
	...
	AWSAppSyncRealTimeProvider.prototype._handleIncomingSubscriptionMessage = function(
		message
	) {
		logger.debug(
	...
	AWSAppSyncRealTimeProvider.prototype._timeoutDisconnect = function() {
		this.subscriptionObserverMap.forEach(function(_a) {
			...
			if (!observer.closed) {
				observer.error({
					errors: [
						__assign({}, new graphql_1.GraphQLError('Timeout disconnect')),
					],
				});
				observer.complete();
			}
	...
	AWSAppSyncRealTimeProvider.prototype._timeoutStartSubscriptionAck = function(
		subscriptionId
	) {
	...
	AWSAppSyncRealTimeProvider.prototype._initializeWebSocketConnection = function(
		_a
	) {
		var _this = this;
								...
								return new Promise(function(res, rej) {
									...
									_this.awsRealTimeSocket.onmessage = function(message) {
										...
										var type = data.type,
											...
											connectionTimeoutMs =
												_b === void 0 ? DEFAULT_KEEP_ALIVE_TIMEOUT : _b;
										if (type === MESSAGE_TYPES.GQL_CONNECTION_ACK) {
											ackOk = true;
											_this.keepAliveTimeout = connectionTimeoutMs;
											_this.awsRealTimeSocket.onmessage = _this._handleIncomingSubscriptionMessage.bind(
												_this
											);
									...
									function checkAckOk() {
										if (!ackOk) {
											rej(
												new Error(
													'Connection timeout: ack from AWSRealTime was not received on ' +
	...
	AWSAppSyncRealTimeProvider.prototype._awsRealTimeHeaderBasedAuth = function(
		_a
	) {
				...
				switch (_b.label) {
					case 0:
						...
						if (typeof handler !== 'function') {
							logger.debug(
								'Authentication type ' + authenticationType + ' not supported'
							);
							return [2 /*return*/, ''];
						}
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					...
					case 1:
						...
						return [
							4 /*yield*/,
							core_1.Credentials.get().then(function(credentials) {
								return {
