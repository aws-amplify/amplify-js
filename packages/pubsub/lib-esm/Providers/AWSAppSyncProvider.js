					...
					return __generator(this, function(_b) {
						switch (_b.label) {
							case 0:
								...
								(_a = options.mqttConnections),
									(mqttConnections = _a === void 0 ? [] : _a),
									(newSubscriptions = options.newSubscriptions);
								...
								map = Object.entries(
									targetTopics.reduce(function(acc, elem) {
										var connectionInfoForTopic = mqttConnections.find(function(
											c
										) {
			...
			return function() {
				...
				targetTopics.forEach(function(t) {
					...
					if (client && client.isConnected()) {
						...
						if (
							!Array.from(_this._topicClient.values()).some(function(c) {
								return c === client;
							})
						) {
