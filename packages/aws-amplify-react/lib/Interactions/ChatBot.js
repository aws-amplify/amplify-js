...
var ChatBot = /** @class */ (function(_super) {
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						if (
							!interactions_1.default ||
							typeof interactions_1.default.send !== 'function'
						) {
							throw new Error(
	...
	ChatBot.prototype.componentDidMount = function() {
		...
		if (onComplete && botName) {
			if (
				!interactions_1.default ||
				typeof interactions_1.default.onComplete !== 'function'
			) {
				throw new Error(
					'No Interactions module found, please ensure @aws-amplify/interactions is imported'
				);
			...
			// @ts-ignore
			interactions_1.default.onComplete(
				botName,
	...
	ChatBot.prototype.render = function() {
		var _a = this.props,
			...
			onComplete = _a.onComplete;
		return React.createElement(
			AmplifyUI_1.FormSection,
			{ theme: theme },
			title &&
				React.createElement(
					AmplifyUI_1.SectionHeader,
					{ theme: theme },
					core_1.I18n.get(title)
				),
			React.createElement(
				AmplifyUI_1.SectionBody,
				{ theme: theme },
				React.createElement(
					'div',
