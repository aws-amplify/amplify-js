...
var IconButton = function(props) {
	...
	switch (props.variant) {
		...
		case 'maximize':
			buttonIcon = React.createElement(
				...
				React.createElement(
					'g',
					{ id: 'icons/minis/screenfull', fill: 'none', fillRule: 'evenodd' },
					React.createElement('path', {
						d:
							'M2.04162598,3 L2.04162598,16 L17.0147705,16 L17.0147705,3 L2.04162598,3 Z M1,2 L18,2 L18,17 L1,17 L1,2 Z M3,4 L16,4 L16,15 L3,15 L3,4 Z',
						id: 'Rectangle-Copy',
						fill: '#FFF',
						fillRule: 'nonzero',
					})
		...
		case 'minimize':
			buttonIcon = React.createElement(
				...
				React.createElement(
					'g',
					{ id: 'icons/minis/screensmall', fill: 'none', fillRule: 'evenodd' },
					React.createElement('path', {
						d:
							'M11,16 L17.0147705,16 L17.0147705,3 L2.04162598,3 L2.04162598,10 L11,10 L11,16 Z M1,2 L18,2 L18,17 L1,17 L1,2 Z',
						id: 'Rectangle',
						fill: '#FFF',
						fillRule: 'nonzero',
					})
	...
	return React.createElement(
		Tooltip_1.default,
		{ text: props.tooltip, autoShowTooltip: props.autoShowTooltip },
		React.createElement(
			'button',
			{ className: AmplifyUI.actionButton, onClick: props.onClick },
			buttonIcon
		)
	);
};
