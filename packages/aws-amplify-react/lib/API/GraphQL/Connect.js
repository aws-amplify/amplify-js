			...
			return __generator(this, function(_k) {
				switch (_k.label) {
					case 0:
						...
						if (
							!api_1.default ||
							typeof api_1.default.graphql !== 'function' ||
							typeof api_1.default.getGraphqlOperationType !== 'function'
						) {
							throw new Error(
						...
						hasValidQuery =
							query && api_1.default.getGraphqlOperationType(query) === 'query';
						hasValidMutation =
							mutation &&
							api_1.default.getGraphqlOperationType(mutation) === 'mutation';
						hasValidSubscription =
							subscription &&
							api_1.default.getGraphqlOperationType(subscription.query) ===
								'subscription';
					...
					case 1:
						...
						return [
							4 /*yield*/,
							api_1.default.graphql({ query: query, variables: variables }),
						];
					case 2:
						response = _k.sent();
						// @ts-ignore
