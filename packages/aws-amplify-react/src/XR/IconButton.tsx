...
const IconButton = (props) => {
  ...
  switch(props.variant) {
    case "sound-mute":
      ...
      buttonIcon = (
        <svg width='19' height='19' viewBox='0 0 19 19' xmlns='http://www.w3.org/2000/svg'>
          <g id='icons/minis/volumeOff' fill='none' fillRule='evenodd'>
    ...
    case "sound":
      ...
      buttonIcon = (
        <svg width='19' height='19' viewBox='0 0 19 19' xmlns='http://www.w3.org/2000/svg'>
          <g id='icons/minis/volumeOn' fill='none' fillRule='evenodd'>
    ...
    case "maximize":
      ...
      buttonIcon = (
        <svg width='19' height='19' viewBox='0 0 19 19' xmlns='http://www.w3.org/2000/svg'>
          <g id='icons/minis/screenfull' fill='none' fillRule='evenodd'>
            <path d='M2.04162598,3 L2.04162598,16 L17.0147705,16 L17.0147705,3 L2.04162598,3 Z M1,2 L18,2 L18,17 L1,17 L1,2 Z M3,4 L16,4 L16,15 L3,15 L3,4 Z'
            id='Rectangle-Copy' fill='#FFF' fillRule='nonzero' />
          </g>
        </svg>
      );
      // tslint:enable:max-line-length
    ...
    case "minimize":
      ...
      buttonIcon = (
        <svg width='19' height='19' viewBox='0 0 19 19' xmlns='http://www.w3.org/2000/svg'>
          <g id='icons/minis/screensmall' fill='none' fillRule='evenodd'>
            <path d='M11,16 L17.0147705,16 L17.0147705,3 L2.04162598,3 L2.04162598,10 L11,10 L11,16 Z M1,2 L18,2 L18,17 L1,17 L1,2 Z'
            id='Rectangle' fill='#FFF' fillRule='nonzero' />
          </g>
        </svg>
      );
      // tslint:enable:max-line-length
    ...
    case "enter-vr":
      ...
      buttonIcon = (
        <svg width='19' height='19' viewBox='0 0 19 19' xmlns='http://www.w3.org/2000/svg'>
          <g id='icons/minis/VRon-Copy' fill='none' fillRule='evenodd'>
            <g id='Group-7-Copy' transform='translate(1 3)' fill='#FFF'>
