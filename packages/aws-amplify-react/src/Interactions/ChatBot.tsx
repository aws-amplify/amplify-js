...
export class ChatBot extends Component<any, any> {
    ...
    async lexResponseHandler() {
        ...
        const response: any = await Interactions.send(this.props.botName, interactionsMessage);
        this.setState({
    ...
    async submit(e) {
        ...
        const response: any = await Interactions.send(this.props.botName, this.state.inputText);
