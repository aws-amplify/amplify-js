...
const styles: { [pname: string]: CSSProperties } = {
    itemMe: {
        padding: 10,
        fontSize: 12,
        color: 'gray',
    ...
    textInput: { ...Input, display: 'inline-block', width: 'calc(100% - 90px - 15px)' },
    button: { ...Button, width: '90px', float: 'right' }
};

export interface IChatBotProps {
    botName?: string;
    clearOnComplete?: boolean;
    onComplete?: (err, confirmation) => string;
    theme?: IAmplifyTheme;
    title?: string;
