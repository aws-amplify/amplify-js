...
export type AmplifyThemeEntry = CSSProperties | { [pname: string]: CSSProperties };
export interface IAmplifyTheme {
  [pname: string]: AmplifyThemeEntry;
}

const AmplifyTheme: IAmplifyTheme = {
  container: Container,
