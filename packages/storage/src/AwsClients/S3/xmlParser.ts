...
/**
 * XML parser used in Non-browser environments, like React Native and Node.js. This is the same XML parser
 * implementation as used in AWS SDK S3 client. It depends on pure JavaScript XML parser library `fast-xml-parser`.
 *
