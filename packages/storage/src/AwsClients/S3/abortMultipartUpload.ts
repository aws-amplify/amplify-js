...
const abortMultipartUploadSerializer = (input: AbortMultipartUploadInput, endpoint: Endpoint): HttpRequest => {
...
const abortMultipartUploadDeserializer = async (response: HttpResponse): Promise<AbortMultipartUploadOutput> => {
