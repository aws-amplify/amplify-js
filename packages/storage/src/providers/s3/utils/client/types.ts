 ...
 * * {@link CompatibleHttpResponse}: Add compatible interface for response payload
 * to harmonize AWS SDK and custom clients.
...
export interface AbortMultipartUploadRequest {
	 ...
	 *  <p>When using this action with an access point, you must direct requests to the access point hostname.
	 ...
	 *    see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-access-points.html">
	 *    Using access points</a> in the <i>Amazon S3 User Guide</i>.</p>
	 *    <p>When you use this action with Amazon S3 on Outposts,
	 *    you must direct requests to the S3 on Outposts hostname. The S3 on Outposts hostname takes the form <code>
	 *    <i>AccessPointName</i>-<i>AccountId</i>.<i>outpostID</i>.s3-outposts.<i>Region</i>.amazonaws.com</code>.
	 * 	  When you use this action with S3 on Outposts through the Amazon Web Services SDKs,
	 *    you provide the Outposts access point ARN in place of the bucket name.
	 * 	  For more information about S3 on Outposts ARNs,
	 *    see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3onOutposts.html">
	 *    What is S3 on Outposts</a> in the <i>Amazon S3 User Guide</i>.</p>
	 ...
	 *          objects from Requester Pays buckets,
	 *          see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html">Downloading Objects in
	 *          Requester Pays Buckets</a> in the <i>Amazon S3 User Guide</i>.</p>
	 */
	RequestPayer?: RequestPayer | string;
	/**
	 * <p>The account ID of the expected bucket owner. If the bucket is owned by a different account,
	 *  the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p>
	 */
 ...
 */
/**
 * This interface extends from `UploadPartRequest` interface.
 * There are more parameters than `Body` defined in {@link UploadPartRequest}
 */
...
/**
 * This interface extends from `PutObjectRequest` interface.
 * There are more parameters than `Body` defined in {@link PutObjectRequest}
 */
...
export interface CompleteMultipartUploadOutput {
	 ...
	 *   <i>AccessPointName</i>-<i>AccountId</i>.s3-accesspoint.<i>Region</i>.amazonaws.com.
	 *   When using this action with an access point through the Amazon Web Services SDKs,
	 *   you provide the access point ARN in place of the bucket name. For more information about access point ARNs,
	 *   see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-access-points.html">Using access points</a>
	 *   in the <i>Amazon S3 User Guide</i>.</p>
	 *   <p>When you use this action with Amazon S3 on Outposts, you must direct requests to the S3 on Outposts hostname.
	 *   The S3 on Outposts hostname takes the form <code>
	 *   <i>AccessPointName</i>-<i>AccountId</i>.<i>outpostID</i>.s3-outposts.<i>Region</i>.amazonaws.com</code>.
	 *   When you use this action with S3 on Outposts through the Amazon Web Services SDKs,
	 *   you provide the Outposts access point ARN in place of the bucket name.
	 *   For more information about S3 on Outposts ARNs,
	 *   see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3onOutposts.html">What is S3 on Outposts
	 ...
	 *     with the object. With multipart uploads, this may not be a checksum value of the object.
	 *     For more information about how checksums are calculated
	 *     with multipart uploads,
	 *     see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html#large-object-checksums">
	 *     Checking object integrity</a> in the <i>Amazon S3 User Guide</i>.</p>
	 */
	ChecksumCRC32?: string;
	/**
	 * <p>The base64-encoded, 32-bit CRC32C checksum of the object. This will only be present if it was uploaded
	 *     with the object. With multipart uploads,
	 *     this may not be a checksum value of the object. For more information about how checksums are calculated
	...
	VersionId?: string;
	/**
	 * <p>If present, specifies the ID of the Amazon Web Services Key Management Service
	 *          (Amazon Web Services KMS) symmetric
...
export interface CompleteMultipartUploadRequest {
	 ...
	 *          <p>When using this action with an access point,
	 *          you must direct requests to the access point hostname.
	 *          The access point hostname takes the form <i>AccessPointName
	 *          </i>-<i>AccountId</i>.s3-accesspoint.<i>Region</i>.amazonaws.com.
	 *          When using this action with an access point through the Amazon Web Services SDKs,
	 *          you provide the access point ARN in place of the bucket name.
	 *          For more information about access point ARNs, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-access-points.html">
	 *          Using access points</a> in the <i>Amazon S3 User Guide</i>.</p>
	 *          <p>When you use this action with Amazon S3 on Outposts,
	 *          you must direct requests to the S3 on Outposts hostname.
	 *          The S3 on Outposts hostname takes the form <code>
	 *          <i>AccessPointName</i>-<i>AccountId</i>.<i>outpostID</i>.s3-outposts.<i>Region</i>.amazonaws.com</code>.
	 *          When you use this action with S3 on Outposts through the Amazon Web Services SDKs,
	 *          you provide the Outposts access point ARN in place of the bucket name.
	 *          For more information about S3 on Outposts ARNs, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3onOutposts.html">What is S3 on Outposts</a> in the <i>Amazon S3 User Guide</i>.</p>
	 * <p>Note: To supply the Multi-region Access Point (MRAP) to Bucket,
	 *          you need to install the "@aws-sdk/signature-v4-crt" package to your project dependencies.
	 * For more information, please go to https://github.com/aws/aws-sdk-js-v3#known-issues</p>
	 */
	...
	UploadId: string | undefined;
	/**
	 * <p>This header can be used as a data integrity
	 *     check to verify that the data received is the same data that was originally sent.
	...
	ChecksumCRC32?: string;
	/**
	 * <p>This header can be used as a data integrity check to verify that
	 *     the data received is the same data that was originally sent.
	...
	ChecksumCRC32C?: string;
	/**
	 * <p>This header can be used as a data integrity check to
	 *     verify that the data received is the same data that was originally sent.
	...
	ChecksumSHA1?: string;
	/**
	 * <p>This header can be used as a data integrity check to verify
	 *     that the data received is the same data that was originally sent.
	 ...
	 *     This parameter is needed only when the object was created
	 *     using a checksum algorithm. For more information,
	 *     see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html">
	 *     Protecting data using SSE-C keys</a> in the
	 *     <i>Amazon S3 User Guide</i>.</p>
	 */
	SSECustomerAlgorithm?: string;
	/**
	 * <p>The server-side encryption (SSE) customer managed key.
	...
	/**
	 * <p>The MD5 server-side encryption (SSE) customer managed key.
...
export interface CopyObjectRequest {
	 ...
	 *          <i>AccountId</i>.s3-accesspoint.<i>Region</i>.amazonaws.com.
	 *          When using this action with an access point through the Amazon Web Services SDKs,
	 *          you provide the access point ARN in place of the bucket name.
	 *          For more information about access point ARNs,
	 *          see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-access-points.html">
	 ...
	 *          <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-points.html">access point</a>:</p>
	 *          <ul>
	 *             <li>
	 ...
	 *             </li>
	 *             <li>
	 *          <p>For objects accessed through access points, specify the Amazon Resource Name
	 *          (ARN) of the object as accessed through the access point,
	 *          in the format <code>arn:aws:s3:<Region>:<account-id>:accesspoint/<access-point-name>/object/<key></code>.
	 *          For example, to copy the object <code>reports/january.pdf</code>
	 *          through access point <code>my-access-point</code> owned by account
	 ...
	 *                 The value must be URL encoded.</p>
	 *                <note>
	 *                   <p>Amazon S3 supports copy operations using access points only when
	 *                    the source and destination buckets are in the same Amazon Web Services Region.</p>
	 *                </note>
	 *                <p>Alternatively, for objects accessed through Amazon S3 on Outposts,
	 *                specify the ARN of the object as accessed in the format
	 *                <code>arn:aws:s3-outposts:<Region>:<account-id>:outpost/<outpost-id>/object/<key></code>.
	 *                For example, to copy the object <code>reports/january.pdf</code>
	 *                through outpost <code>my-outpost</code>
	 *                owned by account <code>123456789012</code> in Region <code>us-west-2</code>,
	 ...
	 *          Amazon Web Services SDKs and Amazon Web Services
	...
	/**
	 * <p>The account ID of the expected destination bucket owner.
	 * If the destination bucket is owned by a different account,
	 * the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p>
	 */
	ExpectedBucketOwner?: string;
	/**
	 * <p>The account ID of the expected source bucket owner.
	 * If the source bucket is owned by a different account,
	 * the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p>
	 */
...
export interface HeadObjectRequest {
	 ...
	 * When you use this action with S3 on Outposts through the Amazon Web Services SDKs,
	 * you provide the Outposts access point ARN in place of the bucket name.
	 * For more information about S3 on Outposts ARNs, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3onOutposts.html">
	 * What is S3 on Outposts</a> in the <i>Amazon S3 User Guide</i>.</p>
	 * <p>Note: To supply the Multi-region Access Point (MRAP) to Bucket,
	 * you need to install the "@aws-sdk/signature-v4-crt" package to your project dependencies.
	 * For more information, please go to https://github.com/aws/aws-sdk-js-v3#known-issues</p>
	...
	PartNumber?: number;
	/**
	 * <p>The account ID of the expected bucket owner.
...
export interface PutObjectRequest {
	...
	ContentType?: string;
	/**
	 * <p>Indicates the algorithm used to create the checksum for the object when using the SDK.
	 *     This header will not provide any additional functionality if not using the SDK. When sending this header,
	 *     there must be a corresponding <code>x-amz-checksum</code> or
	 *     <code>x-amz-trailer</code> header sent. Otherwise,
	 *     Amazon S3 fails the request with the HTTP status code <code>400 Bad Request</code>. For more
...
export interface UploadPartRequest {
	 ...
	 *     When sending this header, there must be a corresponding <code>x-amz-checksum</code> or
	 *     <code>x-amz-trailer</code> header sent.
	 *     Otherwise, Amazon S3 fails the request with the HTTP status code <code>400 Bad Request</code>.
	 *     For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">
	 *     Checking object integrity</a> in
	 *     the <i>Amazon S3 User Guide</i>.</p>
	 *          <p>If you provide an individual checksum, Amazon S3 ignores any provided
	 *             <code>ChecksumAlgorithm</code> parameter.</p>
	...
	ChecksumCRC32?: string;
	/**
	 * <p>This header can be used as a data integrity check to verify that the data received
