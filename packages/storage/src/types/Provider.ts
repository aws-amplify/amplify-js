...
import { StorageCopySource, StorageCopyDestination, StorageCopyConfig } from './Storage';
...
export interface StorageProvider {
	...
	copy?(src: StorageCopySource, dest: StorageCopyDestination, config?, userAgentValue?: string): Promise<any>;
	...
	getProperties?(key: string, options?, userAgentValue?: string): Promise<Object>;

	// upload storage object
	put(key: string, object, options?, userAgentValue?: string): Promise<Object> | UploadTask;
