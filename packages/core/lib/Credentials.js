...
var Credentials = /** @class */ (function() {
	function Credentials(config) {
		...
		this._refreshHandlers['google'] =
			OAuthHelper_1.GoogleOAuth.refreshGoogleToken;
		this._refreshHandlers['facebook'] =
			OAuthHelper_1.FacebookOAuth.refreshFacebookToken;
	}
	...
	Credentials.prototype._pickupCredentials = function() {
		...
		if (!this._gettingCredPromise || !this._gettingCredPromise.isPending()) {
			...
			if (
				...
				this._gettingCredPromise = JS_1.default.makeQuerablePromise(
					...
					return __generator(this, function(_a) {
						switch (_a.label) {
							case 0:
								...
								if (
									!(
										Amplify_1.default.Cache &&
										typeof Amplify_1.default.Cache.setItem === 'function'
									)
								)
									return [3 /*break*/, 2];
								return [
									4 /*yield*/,
									Amplify_1.default.Cache.setItem(
										'federatedInfo',
										{
											provider: provider,
											token: token,
