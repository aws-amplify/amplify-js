...
import { formattedDates, getDefaultRequest, signingOptions } from './testUtils/data';
...
jest.mock('../../../../../../src/clients/middleware/signing/signer/signatureV4/utils/getSignature', () => ({
	getSignature: jest
		.fn()
		.mockImplementation(
			jest.requireActual('../../../../../../src/clients/middleware/signing/signer/signatureV4/utils/getSignature')
				.getSignature
		),
}));
