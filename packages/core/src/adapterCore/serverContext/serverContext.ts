...
import { AmplifyClass } from '~/src/singleton';
import { LibraryOptions, ResourcesConfig } from '~/src/singleton/types';
import { AmplifyServerContextError } from '~/src/adapterCore/error';
