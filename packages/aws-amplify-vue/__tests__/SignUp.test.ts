...
import SignUp from '@/components/authenticator/SignUp.vue';
import PhoneField from '@/components/authenticator/PhoneField.vue';
import AmplifyPlugin from '@/plugins/AmplifyPlugin';
import { signUpWithUsername } from '@/assets/default-sign-up-fields';
