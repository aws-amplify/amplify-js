    ...
    <div v-bind:class="amplifyUI.formField">
        <div v-if="shouldRenderUsernameField">
            ...
            <input
                ...
                v-model="username"
                :placeholder="I18n.get(`Enter your ${getUsernameLabel()}`)"
                autofocus
        ...
        <div v-if="shouldRenderEmailField">
            <div v-bind:class="amplifyUI.inputLabel">{{I18n.get('Email')}} *</div>
            <input
                v-bind:class="amplifyUI.input"
                v-model="email"
...
import { composePhoneNumber, labelMap } from './common';
...
export default BaseComponent.extend({
  ...
  computed: {
    ...
    shouldRenderPhoneNumberField(): boolean {
