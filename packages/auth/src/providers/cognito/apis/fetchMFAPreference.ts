...
import { FetchMFAPreferenceRequest } from '../types/requests';
 ...
 * and settings.
 * @returns FetchMFAPreferenceRequest
 */
export async function fetchMFAPreference(): Promise<FetchMFAPreferenceRequest> {
