...
export declare type LegacyProvider =
	| 'google'
	| 'facebook'
	| 'amazon'
	| 'developer'
...
export declare function isFederatedSignInOptions(
	obj: any
): obj is FederatedSignInOptions;
export declare function isFederatedSignInOptionsCustom(
	obj: any
...
export declare function isCognitoHostedOpts(
	oauth: OAuthOpts
...
export declare type ClientMetaData =
	...
	| undefined;
export declare function isUsernamePasswordOpts(
	obj: any
): obj is UsernamePasswordOpts;
