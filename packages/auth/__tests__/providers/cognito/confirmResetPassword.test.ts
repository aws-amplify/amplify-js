...
describe('ConfirmResetPassword API happy path cases', () => {
	...
	beforeEach(() => {
		confirmResetPasswordSpy = jest.spyOn(confirmResetPasswordClient, 'confirmResetPasswordClient')
			.mockImplementation(async (params: confirmResetPasswordClient.ConfirmResetPasswordClientInput) => {
				return {
					$metadata: {}
				};
			});
	...
	describe('ConfirmResetPassword API error path cases', () => {
		...
		test('ConfirmResetPassword API should raise service error', async () => {
			...
			const spyon = jest.spyOn(confirmResetPasswordClient, 'confirmResetPasswordClient')
