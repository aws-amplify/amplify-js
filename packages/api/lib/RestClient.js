...
*/
				...
				switch (_c.label) {
					...
					case 3:
						...
						params.headers = __assign(
							__assign(__assign({}, libraryHeaders), custom_header),
							initParams.headers
						);
						(_b = urlLib.parse(url, true, true)),
							(search = _b.search),
							(parsedUrl = __rest(_b, ['search']));
						params.url = urlLib.format(
							__assign(__assign({}, parsedUrl), {
								query: __assign(
									__assign({}, parsedUrl.query),
						...
						if (typeof params.headers['Authorization'] !== 'undefined') {
							params.headers = Object.keys(params.headers).reduce(function(
								acc,
								k
							) {
								if (params.headers[k]) {
	...
	RestClient.prototype._signed = function(params, credentials, isAllResponse) {
		...
		var signed_params = core_1.Signer.sign(
			otherParams,
			creds,
			signerServiceInfo
		);
