(function (global, factory) {
    ...
    AmplifyMapLibreRequest.createMapLibreMap = ({ container, center, zoom, style, region, }) => __awaiter(void 0, void 0, void 0, function* () {
        const amplifyRequest = new AmplifyMapLibreRequest(yield core.Amplify.Auth.currentCredentials(), region);
        const transformRequest = amplifyRequest.transformRequest;
        const map = new maplibreGl.Map({
            container,
            center,
            zoom,
            style: style || geo.Geo.getDefaultMap().mapName,
            transformRequest,
        });
        return map;
    });
