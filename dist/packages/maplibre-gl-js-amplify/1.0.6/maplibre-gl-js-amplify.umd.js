(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@aws-amplify/core'), require('@aws-amplify/geo'), require('maplibre-gl'), require('@maplibre/maplibre-gl-geocoder'), require('@maplibre/maplibre-gl-geocoder/dist/maplibre-gl-geocoder.css')) :
    typeof define === 'function' && define.amd ? define(['exports', '@aws-amplify/core', '@aws-amplify/geo', 'maplibre-gl', '@maplibre/maplibre-gl-geocoder', '@maplibre/maplibre-gl-geocoder/dist/maplibre-gl-geocoder.css'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.maplibreAmplify = {}, global.aws_amplify_core, global.aws_amplify_geo, global.maplibregl, global.MaplibreGeocoder));
