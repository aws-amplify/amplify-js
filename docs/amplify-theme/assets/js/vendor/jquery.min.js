!(function(e, t) {
	...
	function c(e, t, n, r) {
		if (ie.acceptData(e)) {
			...
			if (
				...
				return (
					l || (l = s ? (e[a] = J.pop() || ie.guid++) : a),
					u[l] || (u[l] = s ? {} : { toJSON: ie.noop }),
					('object' == typeof t || 'function' == typeof t) &&
						(r
							? (u[l] = ie.extend(u[l], t))
							: (u[l].data = ie.extend(u[l].data, t))),
					(o = u[l]),
	...
	var le = (function(e) {
		...
		return (
			...
			(S = t.select = function(e, t, n, r) {
				...
				return (
					(l || k(e, d))(r, t, !_, n, (be.test(e) && c(t.parentNode)) || t), n
				);
			}),
			(w.sortStable =
				P.split('')
	...
	ie.extend({
		...
		hasData: function(e) {
			return (
				(e = e.nodeType ? ie.cache[e[ie.expando]] : e[ie.expando]), !!e && !l(e)
			);
		},
		data: function(e, t, n) {
			return c(e, t, n);
	...
	(ie.event = {
		...
		trigger: function(t, n, r, i) {
			...
			if (
				...
				if (!i && !l.noBubble && !ie.isWindow(r)) {
					for (
						u = l.delegateType || p, _e.test(u + p) || (s = s.parentNode);
						s;
						s = s.parentNode
					)
						f.push(s), (c = s);
		...
		dispatch: function(e) {
			...
			if (
				...
				for (
					a = ie.event.handlers.call(this, e, u), t = 0;
	...
	(Ye.optgroup = Ye.option),
						...
						if ('object' === ie.type(o)) ie.merge(p, o.nodeType ? [o] : o);
							...
							if (
								...
								for (
									...
									ie.nodeName((l = o.childNodes[i]), 'tbody') &&
										!l.childNodes.length &&
										o.removeChild(l);
							for (
		...
		ie.fn.extend({
			...
			domManip: function(e, t) {
				...
				if (
					p ||
					(l > 1 && 'string' == typeof f && !ne.checkClone && Xe.test(f))
				)
				...
				if (
					...
					for (o = ie.map(g(s, 'script'), b), i = o.length; l > u; u++)
						(r = s),
							u !== d &&
					...
					if (i)
						for (
							a = o[o.length - 1].ownerDocument, ie.map(o, x), u = 0;
							i > u;
							u++
						)
							(r = o[u]),
		...
		style: function(e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var i,
					...
					u = e.style;
				if (
					((t = ie.cssProps[s] || (ie.cssProps[s] = S(u, s))),
